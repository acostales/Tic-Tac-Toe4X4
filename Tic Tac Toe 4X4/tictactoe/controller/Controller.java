...
public class Controller implements ActionListener 
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        if (!game.isGameOver()) 
        {
            ...
            game.setFieldOwner(game.getUserSymbol(),coordinates.first,coordinates.second);
    ...
    private Pair convertToCoordinates(int index) 
    {
        ...
        switch (index) 
        {
            ...
            case 4: first = 1; second = 0; break;
            case 5: first = 1; second = 1; break;
            case 6: first = 1; second = 2; break;
            case 7: first = 1; second = 3; break;
            case 8: first = 2; second = 0; break;
            case 9: first = 2; second = 1; break;
            case 10: first = 2; second = 2; break;
            case 11: first = 2; second = 3; break;
            case 12: first = 3; second = 0; break;
            case 13: first = 3; second = 1; break;
            case 14: first = 3; second = 2; break;
            case 15: first = 3; second = 3; break;
        }
